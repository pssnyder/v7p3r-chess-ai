"""
V7P3R AI v6.1 - Fast Training with Simple Features
Uses fast feature extraction for 10-epoch test run
"""
...
CONFIG = {
    ...
    'batch_size': 256,
    'learning_rate': 0.001,
    'hidden_dims': [512, 256, 128],  # Smaller network for simpler features
    'dropout': 0.3,
    'train_val_split': 0.8,
    'random_seed': 42,
    'max_positions': 50000,
...
def load_positions_fast(max_positions=50000):
    """Load positions with fast feature extraction"""
    print("\n🔄 Loading positions with fast feature extraction...")
    ...
    with open(data_path, 'r') as f:
        for line in f:
            ...
            try:
                ...
                if positions_loaded % 10000 == 0:
                    print(f"  Processed {positions_loaded:,} positions...")
    ...
    print(f"  ⚠  Skipped {positions_skipped:,} positions")
...
def main():
    print("=" * 70)
    print("V7P3R AI v6.1 - FAST TRAINING")
    print("Stage 1: Position Evaluator (10 epochs)")
    print("=" * 70)
    ...
    features, labels, weights = load_positions_fast(CONFIG['max_positions'])
